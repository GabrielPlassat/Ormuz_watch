...
def run() -> dict:
    ...
    if not run_gdelt:
        ...
        GDELT_GROUPS = {
            "physical_strait": {
                "eids":  ["E01", "E02", "E03"],
                "query": ("IRGC tanker seized OR warning shot VLCC Hormuz OR "
                          "sea mines Strait Hormuz OR Iran detained ship"),
                "label": "Physique — Détroit",
            },
            "infra_military": {
                "eids":  ["E04", "E05", "E06", "E13", "E15"],
                "query": ("ADNOC attack Fujairah OR Petroline pipeline Saudi attack OR "
                          "Abqaiq Ras Tanura strike OR Israel attack Iran OR "
                          "IRGC naval exercise Hormuz"),
                "label": "Infrastructure + Militaire",
            },
            "market_shipping": {
                "eids":  ["E07", "E10", "E11", "E14", "E18", "E19"],
                "query": ("war risk insurance Gulf Hormuz Lloyd JWC exclusion OR "
                          "tanker reroute Cape Good Hope Hormuz OR "
                          "Sinopec cancel oil cargo force majeure OR "
                          "Houthi attack ship Red Sea OR "
                          "tanker traffic Hormuz decline OR "
                          "oil trader default Vitol Trafigura"),
                "label": "Marchés + Fret + AIS",
            },
            "institutional": {
                "eids":  ["E12", "E16", "E17", "E20"],
                "query": ("IEA strategic petroleum reserve release OR Japan Korea SPR OR "
                          "secondary sanctions Iran oil China OFAC OR "
                          "cyberattack oil terminal Ras Tanura SCADA"),
