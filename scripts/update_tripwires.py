...
RSS_GROUPS = {
    "physical_strait": {
        "eids":       ["E01", "E02", "E03"],
        "must":       ["hormuz", "strait", "persian gulf"],
        "boost":      ["tanker", "seized", "irgc", "mine", "vessel", "ship",
                       "iran", "detained", "boarded", "warning", "fired"],
        "label":      "Physique — Détroit",
        "thresholds": (1, 3, 7),
    },
    "infra_military": {
        "eids":       ["E04", "E05", "E06", "E13", "E15"],
        "must":       ["saudi", "iran", "israel", "iraq", "gulf"],
        "boost":      ["attack", "strike", "pipeline", "abqaiq", "fujairah",
                       "nuclear", "military", "drone", "missile", "explosion",
                       "aramco", "petroline", "ras tanura"],
        "label":      "Infrastructure + Militaire",
        "thresholds": (1, 3, 8),
    },
    "market_shipping": {
        "eids":       ["E07", "E10", "E11", "E14", "E18", "E19"],
        "must":       ["oil", "shipping", "tanker", "cargo", "houthi", "insurance"],
        "boost":      ["reroute", "cancel", "lloyds", "war risk", "red sea",
                       "bab el", "detour", "default", "sinopec", "cnooc",
                       "good hope", "cape", "vlcc", "freight"],
        "label":      "Marchés + Fret + AIS",
        "thresholds": (2, 5, 12),
    },
    "institutional": {
        "eids":       ["E12", "E16", "E17", "E20"],
        "must":       ["sanctions", "spr", "reserve", "iea", "cyber"],
        "boost":      ["ofac", "china", "iran", "oil", "strategic",
                       "scada", "release", "emergency", "japan", "korea",
                       "secondary", "hack"],
